...
#     top_rank = max(predictions, key=predictions.get)

#     return {
#         "predictions": predictions,
#         "top_rank": {"label": top_rank, "confidence": predictions[top_rank]}
#     }

def pred_img(image, model, processor):
    inputs = processor(images=image, return_tensors="pt")
